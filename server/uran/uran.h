...
#define MANGER_NAME_SIZE_MAX	(14)	//线程名字最大14个字符
	UINT8				pucName[MANGER_NAME_SIZE_MAX];
	void 				(*pUsrCallbck)(INT32, void *, INT32);	//用户回调设置：目前线程异常退出事件
...
* Return:	
* *****************************************************************************/
INT32 UranMangerCreate(MANGER_TYPE _emRole, INT32 _iTrigNum, INT32 (*_pUserHandle)(void *), INT32 _iUserMSec, UINT8 *_pucName, void **_pThis);
/*******************************************************************************
* Name: 
* Descriptions:
* Parameter:	
